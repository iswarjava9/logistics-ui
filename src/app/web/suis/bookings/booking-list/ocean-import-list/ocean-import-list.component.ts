...
@Component({
  selector: 'app-ocean-import-list',
  templateUrl: './ocean-import-list.component.html',
  styleUrls: ['./ocean-import-list.component.css'],
  providers: [BookingListService]
})
export class OceanImportListComponent implements OnInit {
  ...
  createNewBooking() {
   // this.bookingSvc.updateBooking(new Booking());
    ...
    this.router.navigate(['/booking-oceanImp', {editable: true}]);
  }

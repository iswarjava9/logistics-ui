  ...
  @Component({
    selector: 'app-ocean-imp',
    templateUrl: './ocean-imp.component.html',
    styleUrls: ['./ocean-imp.component.css']
  })
  export class OceanImpComponent implements OnInit {
      ...
      this.bookingDetailFormGroup = new FormGroup(
        {
          ...
          'mblDate': new FormControl(null),
          'hblNo': new FormControl(null),
          'hblDate': new FormControl(null),
          'igmNo': new FormControl(null),
          'igmDate': new FormControl(null),
          'cargoDeliveryDate': new FormControl(null),
          'itemLineNo': new FormControl(null),
          'customBroker': new FormControl(null),
          'shipmentAvailableAt': new FormControl(null)
        }
      );
